...
const lastValidation = (e) => {
    ...
    if(e.target.value.length < 1) {
        ...
        setLastError("Last Name must be a last name");
    }
    else {
        setLastError("");
    }
...
const emailValidation = (e) => {
    ...
    if (emailRegex.test(e.target.value) === true) {
        ...
        setEmailError("That isn't a valid email");
    }
}
...
const passwordValidation = (e) => {
    ...
    mediumRegex.test(e.target.value) === true ? setPasswordError("") : setPasswordError("Password isn't strong Enough");
}
const confirmValidation = (e) => {
    ...
    if (password !== e.target.value) {
        ...
        setConfirmError("Congratulations, passwords match!");
    }
}
    return (
